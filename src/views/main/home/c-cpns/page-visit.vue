<template>
  <div class="visit">
    ...
    <div class="content">
      <div class="desc">
        <el-descriptions :column="3" border size="large">
          <el-descriptions-item label="学号" label-align="center" :min-width="120"
            >{{ appointment.preNumber }}
          </el-descriptions-item>
          <el-descriptions-item label="就诊人" label-align="center" :min-width="120">
            {{ appointment.preName }}
          </el-descriptions-item>
      ...
      <div class="reDesc">
        ...
        <el-input v-model="desc" :autosize="{ minRows: 2 }" type="textarea" placeholder="患者就诊描述" />
      </div>
    ...
    <div class="footer">
      <el-button type="primary" size="large" style="width: 150px; margin-top: 30px" @click="handleConfirmClick"
        >完成就诊
      </el-button>
    </div>
  </div>
